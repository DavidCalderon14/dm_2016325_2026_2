...
# construir o recibir las URL correspondientes a cada mes;
# hacer una pausa entre solicitudes;
# extraer la fecha, la temperatura máxima y la temperatura mínima;
# convertir las fechas al tipo Date y las temperaturas a valores numéricos;
# conservar la URL de origen para facilitar la verificación;
# comprobar duplicados, valores faltantes y cobertura de fechas;
# guardar el resultado en un archivo CSV.

url_taller <- "https://www.accuweather.com/es/co/bogota/107487/weather-forecast/107487?type=locality"

# Leemos el HTML de la página
pagina_taller <- read_html(url_taller)
pagina_taller

nodos_taller <- pagina_taller %>%
  html_elements("article.product_pod")
length(nodos_taller)
